        ...
        >
          ...
          >
            ...
            <HStack gap={"10px"}>
              <HiLocationMarker />
              <Text textAlign={"left"}>
              14, Parthasarathy Nagar, Second Street, Adambakkam,
                <br /> Chennai, T.N. India
              </Text>
            </HStack>
            <HStack gap={"10px"}>
              <BsFillTelephoneFill />
              <Text>+91 9080185567</Text>
            </HStack>
            <HStack gap={"10px"}>
              <MdEmail />
              <Text>bharathabdeviellers@gmail.com</Text>
            </HStack>
            <HStack>
              <Box _hover={{ color: "#0A66C2", cursor: "pointer" }}>
                <Link
                  href="https://www.linkedin.com/in/bharath-kumar-a47807252/"
                  target={"_blank"}
                >
              ...
              <Box _hover={{ color: "#6e5494", cursor: "pointer" }}>
                <Link href="https://github.com/Bharathkumar1999" target={"_blank"}>
